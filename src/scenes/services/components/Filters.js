...
class Filters extends Component {
  countDonors() {
    ...
    const text = count > 1 ? <FormattedMessage id="services.filters.services" defaultMessage="Services"/>
      : <FormattedMessage id="services.filters.service" defaultMessage="Service"/>;
