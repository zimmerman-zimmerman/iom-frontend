...
class Home extends Component {
  ...
  render() {
    ...
    const imageBanner = homeMediaContent.success
      ? simpleContentHost.concat(get(homeMediaContent.data, "image"))
      : null;
      ...
      <Spin spinning={homeService.request || donutData.request}>
        <Page pageName={<Trans id="main.menu.home" text="Home" />}>
          ...
          <MediaQuery
            ...
            maxWidth={screenSize.tablet.maxWidth}
          >
          ...
          <Grid fluid>
            <Row middle="xs">
              <Col xs={12} md={12} lg={4}>
                <HomeDonors
                  dataResults={donutContent.Donors}
                  request={donutRequest}
                />
              </Col>
              <Col xs={12} md={12} lg={4}>
                <HomeServices
                  dataResults={donutContent.Services}
                  request={donutRequest}
                  detailLink="services/"
                />
              </Col>
              <Col xs={12} md={12} lg={4}>
                <HomeActivities
                  dataResults={donutContent.Projects}
                  request={donutRequest}
                />
              </Col>
            </Row>
