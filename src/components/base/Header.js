  ...
  render() {
        ...
        <Row middle={size} className={classes.share}>
          <Col lg={12}>
            <Button
              shape="circle"
              onClick={() =>
                (window.location = "https://twitter.com/UNmigration")
              }
              icon="twitter"
            />
            <Button
            ...
            <Button
              shape="circle"
              onClick={() =>
                (window.location = "https://www.iom.int/rss-feeds")
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                this.props.dispatch(
                  genericActions.toggleModalRequest(<ShareDialog />, true)
                )
              }
            >
              <ShareIcon className="share-icon" />
            </Button>
            <Button shape="circle" onClick={() => auth0Client.signOut()}>
              <LogOut className="share-icon" />
            </Button>
          </Col>
        </Row>
      );
      ...
      return (
        <div className={classes.innerHeader}>
          ...
          <div className={classes.tabsHeader}>
            {size === "lg" ? (
              <Menus items={menuItems} urlPath={urlPath} />
            ) : null}
            {size === "xs" || size === "md" ? (
              <TriggerMenu size={size} />
            ) : null}
          </div>
          {size === "lg" ? (
            <div className={classes.shareCol}>
              <Share size={size} />
            </div>
          ) : null}
        </div>
    ...
    return (
      <Grid fluid className={classes.header}>
        ...
        <MediaQuery
          minWidth={screenSize.tablet.minWidth}
          maxWidth={screenSize.tablet.headerMaxWidth}
        >
          <Content size="md" />
        </MediaQuery>
